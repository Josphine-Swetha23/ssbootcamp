...
import ModalFaq from "../modal/faqModal";
  ...
  return (
      ...
      <div className={styles.footerwrappers}>
        <ul className={styles.wrapper}>
          <li className={`${styles.icon} ${styles.facebook}`}>
            ...
            <span>
              {" "}
              <Link href="https://www.linkedin.com/company/sight-spectrum-llc/?originalSubdomain=in">
                <img className={styles.social} src="linkedin-in.svg" />
              </Link>{" "}
            </span>
          </li>
          <li
    ...
    `}
          >
            ...
            <span>
              {" "}
              <Link href="https://twitter.com/SightSpectrumUS">
                <img className={styles.social} src="twitter.svg" />
              </Link>{" "}
            </span>
          </li>
          <li className={`${styles.icon} ${styles.instagram}`}>
            ...
            <span>
              {" "}
              <Link href="https://www.instagram.com/sightspectrumus/">
                <img className={styles.social} src="instagram.svg" />
              </Link>{" "}
            </span>
          </li>
        </ul>
        <div className={styles.footerwrapper}>
          <div className={styles.footerlinks}>
            ...
            <div className={styles.footerlink} href="">
              {" "}
              <Link href="/comingsoon">Who We Are</Link>{" "}
            </div>
            <div className={styles.footerlink}>
              {" "}
              <Link className={styles.footerlink1} href="/getintouch">
                Get in Touch
              </Link>{" "}
            </div>
          </div>
        ...
        <div className={styles.footerwrapper}>
          ...
          <div className={styles.footerlinks}>
            <div className={styles.footerlink}>
              {" "}
              <Link href="/comingsoon">Accessibilty</Link>{" "}
            </div>
            <div className={styles.footerlink}>
              {" "}
              <Link href="/comingsoon">Copyright Policy</Link>{" "}
            </div>
          </div>
        </div>
        <div className={styles.footerdivider} />
        <div className={styles.footertxt}>
          <div className={styles.footertxt1}>Stay Updated! 🔥</div>
          <div className={styles.footertxt2}>
            Get updates on new programs, tips and snippets on the technology
            right in your inbox.
          </div>
